...
var APIKeyTableColumns = struct {
	...
	ID:        "api_keys.id",
	OwnerID:   "api_keys.owner_id",
	TokenID:   "api_keys.token_id",
...
var APIKeyWhere = struct {
	...
	OwnerID:   whereHelperstring{field: "\"api_keys\".\"owner_id\""},
	TokenID:   whereHelperstring{field: "\"api_keys\".\"token_id\""},
	TokenHash: whereHelperstring{field: "\"api_keys\".\"token_hash\""},
	CreatedAt: whereHelpertime_Time{field: "\"api_keys\".\"created_at\""},
	ExpiresAt: whereHelpertime_Time{field: "\"api_keys\".\"expires_at\""},
}
...
var (
	apiKeyAllColumns            = []string{"id", "owner_id", "token_id", "token_hash", "created_at", "expires_at"}
	apiKeyColumnsWithoutDefault = []string{"owner_id", "token_id", "token_hash", "expires_at"}
...
func (q apiKeyQuery) One(ctx context.Context, exec boil.ContextExecutor) (*APIKey, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pqmodels: failed to execute a one query for api_keys")
	}
...
func (q apiKeyQuery) All(ctx context.Context, exec boil.ContextExecutor) (APIKeySlice, error) {
	...
	err := q.Bind(ctx, exec, &o)
	if err != nil {
		return nil, errors.Wrap(err, "pqmodels: failed to assign all query results to APIKey slice")
	}
...
func (q apiKeyQuery) Count(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: failed to count api_keys rows")
	}
...
func (q apiKeyQuery) Exists(ctx context.Context, exec boil.ContextExecutor) (bool, error) {
	...
	err := q.Query.QueryRowContext(ctx, exec).Scan(&count)
	if err != nil {
		return false, errors.Wrap(err, "pqmodels: failed to check if api_keys exists")
	}
...
func (o *APIKey) Owner(mods ...qm.QueryMod) userQuery {
...
func (apiKeyL) LoadOwner(ctx context.Context, e boil.ContextExecutor, singular bool, maybeAPIKey interface{}, mods queries.Applicator) error {
	var slice []*APIKey
	var object *APIKey
	...
	if singular {
		...
		foreign.R.OwnerAPIKeys = append(foreign.R.OwnerAPIKeys, object)
		return nil
	}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.OwnerID == foreign.ID {
				...
				foreign.R.OwnerAPIKeys = append(foreign.R.OwnerAPIKeys, local)
				break
			}
		}
	}
...
// SetOwner of the apiKey to the related item.
// Sets o.R.Owner to related.
// Adds o to related.R.OwnerAPIKeys.
func (o *APIKey) SetOwner(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
	...
	if related.R == nil {
		related.R = &userR{
			OwnerAPIKeys: APIKeySlice{o},
		}
	} else {
		related.R.OwnerAPIKeys = append(related.R.OwnerAPIKeys, o)
	}
...
func FindAPIKey(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*APIKey, error) {
	...
	if err != nil {
		...
		return nil, errors.Wrap(err, "pqmodels: unable to select from api_keys")
	}
...
func (o *APIKey) Insert(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) error {
	if o == nil {
		return errors.New("pqmodels: no api_keys provided for insertion")
	}
	...
	if err != nil {
		return errors.Wrap(err, "pqmodels: unable to insert into api_keys")
	}
...
func (o *APIKey) Update(ctx context.Context, exec boil.ContextExecutor, columns boil.Columns) (int64, error) {
	...
	if !cached {
		...
		if len(wl) == 0 {
			return 0, errors.New("pqmodels: unable to update api_keys, could not build whitelist")
		}
	...
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to update api_keys row")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: failed to get rows affected by update for api_keys")
	}
...
func (q apiKeyQuery) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to update all for api_keys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to retrieve rows affected for api_keys")
	}
...
func (o APIKeySlice) UpdateAll(ctx context.Context, exec boil.ContextExecutor, cols M) (int64, error) {
	...
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to update all in apiKey slice")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to retrieve rows affected all in update all apiKey")
	}
	return rowsAff, nil
}
...
func (o *APIKey) Upsert(ctx context.Context, exec boil.ContextExecutor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
		return errors.New("pqmodels: no api_keys provided for upsert")
	}
	if !boil.TimestampsAreSkipped(ctx) {
		currTime := time.Now().In(boil.GetLocation())
	...
	if !cached {
		...
		if updateOnConflict && len(update) == 0 {
			return errors.New("pqmodels: unable to upsert api_keys, could not build update column list")
		}
		...
		if len(conflict) == 0 && updateOnConflict && len(update) != 0 {
			if len(apiKeyPrimaryKeyColumns) == 0 {
				return errors.New("pqmodels: unable to upsert api_keys, could not build conflict column list")
			}
	...
	if err != nil {
		return errors.Wrap(err, "pqmodels: unable to upsert api_keys")
	}
...
func (o *APIKey) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if o == nil {
		return 0, errors.New("pqmodels: no APIKey provided for delete")
	}
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to delete from api_keys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: failed to get rows affected by delete for api_keys")
	}
...
func (q apiKeyQuery) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	if q.Query == nil {
		return 0, errors.New("pqmodels: no apiKeyQuery provided for delete all")
	}
	...
	result, err := q.Query.ExecContext(ctx, exec)
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to delete all from api_keys")
	}

	rowsAff, err := result.RowsAffected()
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: failed to get rows affected by deleteall for api_keys")
	}
...
func (o APIKeySlice) DeleteAll(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	result, err := exec.ExecContext(ctx, sql, args...)
	if err != nil {
		return 0, errors.Wrap(err, "pqmodels: unable to delete all from apiKey slice")
	}
...
func (o *APIKeySlice) ReloadAll(ctx context.Context, exec boil.ContextExecutor) error {
	...
	if err != nil {
		return errors.Wrap(err, "pqmodels: unable to reload all in APIKeySlice")
	}
...
func APIKeyExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	...
	err := row.Scan(&exists)
	if err != nil {
		return false, errors.Wrap(err, "pqmodels: unable to check if api_keys exists")
	}
